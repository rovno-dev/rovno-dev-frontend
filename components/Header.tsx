  ...
  return (
    <header
      style={{
        ...
        display: 'flex',
        alignItems: 'center',
        borderBottom: `1px solid ${colorStyles.dark.background.border.default}`,
    ...
    >
      ...
      >
        ...
        <button
          className="hidden md:flex bg-[#3B66F5] hover:bg-[#2a54d8] text-white px-5 py-2 rounded-full text-sm items-center gap-2 transition"
        >
